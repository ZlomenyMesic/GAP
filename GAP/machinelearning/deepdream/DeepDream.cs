...
internal static class DeepDream {
    ...
    // FINAL_LAYERS - 3 most interesting layers placed at the end of the sequence for the best result
    ...
    internal static readonly string[] FINAL_LAYERS = ["mixed2", "mixed3", "mixed5"];
